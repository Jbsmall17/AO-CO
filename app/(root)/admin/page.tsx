        ...
        <section className='px-[5%] bg-[#f5f9f2] py-8 md:py-12 lg:py-14 flex flex-col md:flex-row gap-6 md:gap-8 lg:gap-12'>
            <div className='flex-1 lg:flex-[1.25]'>
                ...
                <div className='flex flex-row gap-6'>
                    ...
                    <Link href="/admin/login" className='cursor-pointer px-5 py-4 rounded-lg text-[#485d3a] bg-white border-2 border-[#485d3a] hover:bg-[#eaeaea] active:btg-[#eaeaea] transition-all duration-300 ease-linear'>
                        Login as Admin
                    </Link>
                </div>
            </div>
