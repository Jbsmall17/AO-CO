    ...
    <main>
        <section className='px-[5%] bg-[#d8e9cd] pb-8 md:pt-10 lg:pt-12 xl:pt-14 pb-10 md:pb-12 lg:pb-14 xl:pb-18 flex justify-center items-center'>
            <div className='relative p-4 pt-8 pb-10 md:p-8'>
                <img src='/star.png' alt="star icon" className='absolute right-12 md:right-16 bottom-2 md:bottom-4' />
                <img className='translate-x-6 md:translate-x-4 translate-y-8 md:translate-y-4 scale-70 lg:scale-80 absolute bottom-0 right-0' src='/thinking.png' alt="thinking icon" />
                <p className='flex'> 
                    <img  className='inline  h-[52px] md:h-[57px] lg:h-[62px] w-[52px] md:w-[57px] lg:w-[62px]' src='/lightbulb.png' alt="lightbulb icon" />
