        ...
        <div className='py-8 px-6 w-[325px] bg-white rounded-2xl border-2 border-[#9dc782]'>
            ...
            <div>
                <div className='flex flex-row mb-4 mb-10'>
                    <FaQuoteLeft className=' shrink-0 text-2xl self-start -translate-y-[10px]' />
                    <p className='text-xl font-normal text-center'>{review}</p>
                    <FaQuoteRight className='shrink-0 text-2xl self-end translate-y-[10px]' />
                </div>
  ...
  return (
    <section className='px-[5%] bg-[#d8e9cd] pt-4 md:pt-6 lg:pt-8 pb-8 md:pb-12 lg:pb-16'>
        ...
        <div className='relative items-center flex flex-col md:flex-row justify-center gap-6'>
            <MdKeyboardArrowLeft className='absolute text-3xl left-0 top-[50%] -translate-y-[50%]' />
            <MdKeyboardArrowRight className='absolute text-3xl right-0 top-[50%] -translate-y-[50%]' />
            <SliderItem 
                image={sliderImg1}
