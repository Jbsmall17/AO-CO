...
import lightbulb from "../assests/lightbulb.png"
    ...
    <main>
        ...
        <section className='px-[5%] bg-[#d8e9cd] pb-8 md:pt-10 lg:pt-12 xl:pt-14 pb-10 md:pb-12 lg:pb-14 xl:pb-18 flex justify-center items-center'>
            <div className='relative p-4 pt-8 pb-10 md:p-8'>
                <Image src={star} alt="star icon" className='absolute right-12 md:right-16 bottom-2 md:bottom-4' />
                <Image className='translate-x-6 md:translate-x-4 translate-y-8 md:translate-y-4 scale-70 lg:scale-80 absolute bottom-0 right-0' src={thinking} alt="thinking icon" />
                <p className='flex'> 
                    <Image  className='inline  h-[52px] md:h-[57px] lg:h-[62px] w-[52px] md:w-[57px] lg:w-[62px]' src={lightbulb} alt="lightbulb icon" />
        ...
        <section className='px-[5%] py-6 md:py-8 lg:py-10'>
            ...
            <div className='flex flex-col md:flex-row gap-6 lg:gap-10 h-auto md:h-[420px]'>
                ...
                <div className='flex-1 self-end'>
                    <div className='mb-4 h-8 w-8 text-base font-semibold flex justify-center items-center text-white rounded-full bg-[#485d3a]'>04</div>
